...
export default class Dromru8 extends Scenario {
    ...
    async run(){
        ...
        if(now.getMinutes()>=0){
            url_go = 'https://auto.drom.ru/used/all/page'+now.getMinutes()+'/';
        }
       /* if(now.getMinutes()>=3){
            url_go = 'https://auto.drom.ru/used/all/page3/?w=1';
        }
        if(now.getMinutes()>=5){
            url_go = 'https://auto.drom.ru/used/all/?fueltype=5&owner_type=2';
        }
        if(now.getMinutes()>=7){
            url_go = 'https://auto.drom.ru/used/all/?fueltype=5&owner_type=1';
        }
        if(now.getMinutes()>=10){
            url_go = 'https://auto.drom.ru/used/all/?fueltype=5&damaged=2&owner_type=2&order=price';
        }
        if(now.getMinutes()>=13){
            url_go = 'https://auto.drom.ru/used/all/?hybrid=1&damaged=2';
        }
        ...
        if(now.getMinutes()>=34){
            url_go = 'https://krasnoyarsk.drom.ru/auto/used/all/page5/?distance=1000';
        }

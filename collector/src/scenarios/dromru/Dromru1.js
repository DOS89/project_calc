...
export default class Dromru1 extends Scenario {
    ...
    async run(){
        ...
        if(now.getMinutes()>=3){
            url_go = 'https://spb.drom.ru/auto/used/all/?order_d=asc';
        }
        if(now.getMinutes()>=5){
            url_go = 'https://spb.drom.ru/auto/used/all/';
        }
        ...
        if(now.getMinutes()>=10){
            url_go = 'https://moscow.drom.ru/auto/used/all/page2/';
        }
        if(now.getMinutes()>=13){
            url_go = 'https://moscow.drom.ru/auto/used/all/?distance=1000';
        }
        if(now.getMinutes()>=16){
            url_go = 'https://auto.drom.ru/region45/used/all/';
        }
        if(now.getMinutes()>=19){
            url_go = 'https://kurgan.drom.ru/auto/used/all/?distance=1000';
        }
        ...
        if(now.getMinutes()>=34){
            url_go = 'https://krasnoyarsk.drom.ru/auto/used/all/page3/?distance=1000';
        }
        if(now.getMinutes()>=38){
            url_go = 'https://vladivostok.drom.ru/auto/used/all/';
        }
        if(now.getMinutes()>=42){
            url_go = 'https://auto.drom.ru/used/all/page2/';
        }
        if(now.getMinutes()>=46){
            url_go = 'https://auto.drom.ru/used/all/page3/';
        }
        if(now.getMinutes()>=52){
            url_go = 'https://auto.drom.ru/region72/used/hatchback/all/';
        }
        if(now.getMinutes()>=56){
            url_go = 'https://auto.drom.ru/region102/used/all/';
        }

...
export default class Dromru4 extends Scenario {
    ...
    async run(){
        ...
        if(now.getMinutes()>=0){
            url_go = 'https://auto.drom.ru/region22/all/';
        }
        if(now.getMinutes()>=3){
            url_go = 'https://auto.drom.ru/region22/all/?distance=1000';
        }
        if(now.getMinutes()>=5){
            url_go = 'https://habarovsk.drom.ru/auto/used/all/';
        }
        if(now.getMinutes()>=7){
            url_go = 'https://auto.drom.ru/region25/used/all/?distance=1000';
        }
        if(now.getMinutes()>=10){
            url_go = 'https://moscow.drom.ru/auto/used/all/';
        }
        if(now.getMinutes()>=13){
            url_go = 'https://moscow.drom.ru/auto/used/all/page2/?distance=1000';
        }

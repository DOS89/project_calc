...
export default class Autoru2 extends Scenario {
    ...
    async run(){
        ...
        if(now.getMinutes()>=7){
            url_go = 'https://auto.ru/vladivostok/cars/used/?top_days=4';
        }
        ...
        if(now.getMinutes()>=13){
            ...
            url_go = 'https://auto.ru/vladivostok/cars/used/?top_days=3';
        }
        if(now.getMinutes()>=16){
            url_go = 'https://auto.ru/habarovsk/cars/used/?top_days=2';
        }
        if(now.getMinutes()>=19){
            url_go = 'https://auto.ru/novosibirskaya_oblast/cars/vaz/used/?top_days=3';
        }
        ...
        if(now.getMinutes()>=35){
            url_go = 'https://auto.ru/cars/used/tag/compact/';
        }
        ...
        await PAGE.goto(url_go, { referer: "https://auto.ru/cars/used/?sort=cr_date-desc", waitUntil: "domcontentloaded" });
        await PAGE.waitForTimeout(2000);
        await PAGE.waitForTimeout(2000);

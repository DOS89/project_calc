...
export default class Dromru5 extends Scenario {
    ...
    async run(){
        ...
        if(now.getMinutes()>=0){
            url_go = 'https://auto.drom.ru/new/all/';
        }
        if(now.getMinutes()>=3){
            url_go = 'https://auto.drom.ru/region22/new/all/';
        }
        if(now.getMinutes()>=5){
            url_go = 'https://irkutsk.drom.ru/auto/new/all/';
        }
        if(now.getMinutes()>=7){
            url_go = 'https://moscow.drom.ru/auto/new/all/';
        }
        if(now.getMinutes()>=10){
            url_go = 'https://moscow.drom.ru/auto/new/all/page2/';
        }
        if(now.getMinutes()>=13){
            url_go = 'https://moscow.drom.ru/auto/new/all/?distance=1000';
        }
        if(now.getMinutes()>=16){
            url_go = 'https://auto.drom.ru/region45/new/all/';
        }
        if(now.getMinutes()>=19){
            url_go = 'https://kurgan.drom.ru/auto/new/all/?distance=1000';
        }
        if(now.getMinutes()>=23){
            url_go = 'https://ufa.drom.ru/auto/new/all/?distance=1000';
        }
        if(now.getMinutes()>=30){
            url_go = 'https://auto.drom.ru/new/all/';
        }
        if(now.getMinutes()>=34){
            url_go = 'https://krasnoyarsk.drom.ru/auto/new/all/page3/?distance=1000';
        }
        if(now.getMinutes()>=36){
            url_go = 'https://auto.drom.ru/new/all/';
        }
        if(now.getMinutes()>=38){
            url_go = 'https://vladivostok.drom.ru/auto/new/all/';
        }
        if(now.getMinutes()>=42){
            url_go = 'https://moscow.drom.ru/auto/new/all/?distance=1000';
        }
        if(now.getMinutes()>=46){
            url_go = 'https://auto.drom.ru/new/all/page3/';
        }
        if(now.getMinutes()>=52){
            url_go = 'https://moscow.drom.ru/auto/new/all/?distance=1000';
        }
        if(now.getMinutes()>=56){
            url_go = 'https://ufa.drom.ru/auto/new/all/page8/?distance=1000';
        }

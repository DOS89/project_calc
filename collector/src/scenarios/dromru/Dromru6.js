...
export default class Dromru6 extends Scenario {
    ...
    async run(){
        ...
        if(now.getMinutes()>=3){
            url_go = 'https://auto.drom.ru/hyundai/used/all/';
        }
        if(now.getMinutes()>=5){
            url_go = 'https://auto.drom.ru/hyundai/used/all/page9/';
        }
        if(now.getMinutes()>=7){
            url_go = 'https://auto.drom.ru/toyota/used/all/';
        }
        if(now.getMinutes()>=10){
            url_go = 'https://auto.drom.ru/lada/used/all/';
        }
        if(now.getMinutes()>=13){
            url_go = 'https://moscow.drom.ru/auto/used/all/';
        }
        if(now.getMinutes()>=16){
            url_go = 'https://auto.drom.ru/bmw/used/all/';
        }
        if(now.getMinutes()>=19){
            url_go = 'https://auto.drom.ru/volkswagen/used/all/';
        }
        if(now.getMinutes()>=23){
            url_go = 'https://auto.drom.ru/uaz/used/all/';
        }
        ...
        if(now.getMinutes()>=38){
            url_go = 'https://moscow.drom.ru/auto/used/all/?distance=1000';
        }
        ...
        if(now.getMinutes()>=52){
            url_go = 'https://ekaterinburg.drom.ru/lada/used/all/';
        }
        if(now.getMinutes()>=56){
            url_go = 'https://chelyabinsk.drom.ru/lada/used/all/';
        }
